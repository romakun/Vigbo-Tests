...
public class ST7a_001 extends BaseTest {
    @BeforeMethod
    ...
    public void runTest() throws InterruptedException {
        ...
        logger.info("Expected result: total price = 4 040 pуб.");
        logger.info("Actual result: total price = "+cartPage.getTotalPrice());
        assertEquals(cartPage.getTotalPrice(),"4 040 pуб.");
        ...
        assertEquals(ordersPage.getOrderTotalPrice(orderNumber),"4 040 pуб.");
    }
}
