...
public class ST7a_012 extends BaseTest {
    ...
    public void runTest() throws InterruptedException {
       ...
       product2Page.goToCatalogByBreadecrumbs();
        ...
        logStep();
        cartPage.applyPromoCode("12a");
        logger.info("Expected result: total price = 3 343.10 pуб.");
        logger.info("Actual result: total price = "+cartPage.getTotalPrice());
        assertEquals(cartPage.getTotalPrice(),"3 343.10 pуб.");
        ...
        assertEquals(ordersPage.getOrderTotalPrice(orderNumber),"3 343.10 pуб.");
    }
}
