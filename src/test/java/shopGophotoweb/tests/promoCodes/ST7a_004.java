...
public class ST7a_004 extends BaseTest {
    ...
    public void runTest() throws InterruptedException {
        ...
        logStep(6);
        cartPage.applyPromoCode("4a");
        logger.info("Expected result: total price = 4 545 pуб.");
        logger.info("Actual result: total price = "+cartPage.getTotalPrice());
        assertEquals(cartPage.getTotalPrice(),"4 545 pуб.");
        ...
        assertEquals(ordersPage.getOrderTotalPrice(orderNumber),"4 545 pуб.");
    }
}
