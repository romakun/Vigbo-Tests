...
public class ST7a_011 extends BaseTest {
    ...
    public void runTest() throws InterruptedException {
       ...
       product2Page.goToCatalogByBreadecrumbs();
        ...
        logStep();
        cartPage.applyPromoCode("11a");
        logger.info("Expected result: total price = 3 277.45 pуб.");
        logger.info("Actual result: total price = "+cartPage.getTotalPrice());
        assertEquals(cartPage.getTotalPrice(),"3 277.45 pуб.");
        ...
        assertEquals(ordersPage.getOrderTotalPrice(orderNumber),"3 277.45 pуб.");
    }
}
