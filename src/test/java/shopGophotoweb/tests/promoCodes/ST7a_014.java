...
public class ST7a_014 extends BaseTest {
    ...
    public void runTest() throws InterruptedException {
       ...
       product1Page.goToCatalogByBreadecrumbs();
        ...
        logStep();
        cartPage.applyPromoCode("14a");
        logger.info("Expected result: total price = 3 322.90 pуб.");
        logger.info("Actual result: total price = "+cartPage.getTotalPrice());
        assertEquals(cartPage.getTotalPrice(),"3 322.90 pуб.");
     ...
     Utilites.goToSidebarItem(Utilites.SidebarItems.Заказы);
        ...
        assertEquals(ordersPage.getOrderTotalPrice(orderNumber),"3 322.90 pуб.");
    }
}
